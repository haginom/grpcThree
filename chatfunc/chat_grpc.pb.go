...
type ChatServiceClient interface {
	//sends a response
	SayHello(ctx context.Context, in *Message, opts ...grpc.CallOption) (*MessageReply, error)
}
...
func (c *chatServiceClient) SayHello(ctx context.Context, in *Message, opts ...grpc.CallOption) (*MessageReply, error) {
...
type ChatServiceServer interface {
	//sends a response
	SayHello(context.Context, *Message) (*MessageReply, error)
...
func (UnimplementedChatServiceServer) SayHello(context.Context, *Message) (*MessageReply, error) {
